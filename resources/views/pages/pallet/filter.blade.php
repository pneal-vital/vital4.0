<!-- Beginning of pages/pallet/filter.blade.php -->
...
@endif
@include('fields.ddList'   , ['fieldName' => 'Status', 'lists' => (['0' => Lang::get('labels.enter.Status')]+Lang::get('lists.pallet.status')), 'onChangeSubmit' => 'true' ])

@include('fields.button')

<!-- End of pages/pallet/filter.blade.php -->
